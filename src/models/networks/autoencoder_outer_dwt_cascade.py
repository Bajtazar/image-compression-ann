...
from gym.modules import CascadeDWT, CascadeIDWT, MaskedConv2d, ActivationFunction
...
class Encoder(Module):
    def __init__(self, device: str) -> None:
        ...
        self.__cdwt = CascadeDWT(decomposition_levels=DECOMPS, wavelet=WAVELET)
...
class Decoder(Module):
    def __init__(self, device: str) -> None:
        ...
        self.__icdwt = CascadeIDWT(decomposition_levels=DECOMPS, wavelet=WAVELET)

    def forward(self, x: Tensor) -> Tensor:
        return self.__sigmoid(self.__icdwt(self.__model(x)))
